...
- [x] System prompt guardrail (strengthened) — ห้าม stop-loss/hedging action แม้ไม่ระบุราคา — เจอ drift ตอน verify รอบแรก, แก้แล้ว verify ซ้ำผ่าน
- [x] Regression retest หลังเพิ่ม guardrail ทั้งสองรอบ — 10/11 passed
  (รอบ 2 เจอ 9/11 ชั่วคราว — isolate case 10 รัน 3x ยืนยันเป็น LLM fluke ไม่ใช่ regression จาก guardrail)
